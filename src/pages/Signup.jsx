    ...
    <div className="w-full min-h-screen flex">
      ...
      >
        <form onSubmit={(e) => handleSubmit(e)} className="max-w-sm w-full">
          <h1
            className="font-display text-blue-500 font-bold text-4xl mb-0"
            style={{ color: "#39798f" }}
          >
            Ignite
          </h1>
          <h2 className="font-semibold text-lg ml-[3px] tracking-wide mb-0">
            We don’t bring people together
          </h2>
          <h2 className="font-semibold text-lg ml-[3px] tracking-wide mb-4">
