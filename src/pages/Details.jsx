      ...
      <section className="overscroll-y-scroll m-8 mb-4 flex flex-col">
        <div className="flex flex-col">
          ...
          <div>
            ...
            {averageScore > 0.0 && (
              <div className="flex items-center space-x-2 px-1">
                <Rating value={averageScore} readOnly precision={0.1} />
          ...
          <div className="my-2 p-2 border">
            ...
            {data.link && <a href={data.link}>More Info</a>}
          </div>
      ...
      {!isAPIEvent && (
        <section className="flex flex-col m-8 max-h-96 mt-0 mb-8">
          <div className="flex space-x-4 items-center -mt-2 pb-2 border-b-2 mr-2">
            ...
            >
              <AddCircleOutlineIcon
                className="text-[#39798f] opacity-80 hover:opacity-100"
                fontSize="large"
              />
            </button>
          ...
          <div className="overflow-y-auto">
            {reviews.length == 0 && (
              <div className="bg-[#ebf3f6] py-8 flex justify-center italic text-[#39798f] drop-shadow-lg">
...
const extractDataFromTicketmaster = (data) => {
  return {
    ...
    imageURL: data?.images?.find(
      (image) => image.width > 1000 && image.ratio == "16_9"
    )?.url,
